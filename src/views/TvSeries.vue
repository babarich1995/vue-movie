      ...
      <div class="col-lg-12">
       ...
       <div class="row">
          <div class="col-lg-8">
             <div class="d-flex justify-content-between">
              <div>
             <h5 class="text-lg text-bold text-white">On Air</h5>
              </div>
              <div>
               <p>See All</p>
              </div>
...
export default {
  ...
  data() {
   ...
   methods:{
     ...
     getMovies(page){
                axios.get(`https://api.themoviedb.org/3/tv/top_rated?api_key=c3612c0718ad5a9e707c01215bac2e37&page= ${page}&language=en-US&region=US`,
     ...
     getUpcomingMovies(page){
                axios.get(`https://api.themoviedb.org/3/tv/on_the_air?api_key=c3612c0718ad5a9e707c01215bac2e37&page= ${page}&language=en-US&region=US`,
